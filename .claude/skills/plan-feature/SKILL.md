...
3. **Write the plan.** Keep it short and technical. Include:
   ...
   - **Manual Test Scenarios** (see below).
...
End every plan with a `## Manual Test Scenarios` section: **3–6 concrete scenarios** the user will run by hand on the Android emulator (these are not automated tests). Cover, at minimum:
